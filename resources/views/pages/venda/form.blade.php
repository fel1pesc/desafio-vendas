...
@section('content')
    ...
    <div class="container-fluid" style="margin-top: 20px;">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                {!! Form::label('nome_cliente', 'Nome Cliente:', ['class' => 'required']) !!}
            ...
            <div class="col-md-3">
                {!! Form::label('email_cliente', 'Email Cliente:', ['class' => 'required']) !!}
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-3">
                        {!! Form::label('desconto', 'Desconto (%):', ['class' => 'required']) !!}
                        {!! Form::text('desconto', null, ['class' => 'form-control', 'onkeypress' => 'return somenteNumeros(event)', 'onkeyup' => 'return atualizarValorTotal()']) !!}
                    ...
                    <div class="offset-7 col-md-2">
                        <p>Valor Total: R$<span style="font-weight: bold" id="valor-total"> 0,00</span></p>
                    </div>
                </div>
            </div>
        </div>
